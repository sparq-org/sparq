// [GPT-6] Execute local BOUND controls and captured-BOUND profile rejections in the real guest.
...
#[test]
fn actual_guest_executes_exists_bound_scope_cases() {
    ...
    let executor = ExternalProver::new("real-sparq-exists-bound-boundary", r0vm);
    ...
    for admitted in [true, false] {
            ...
            .filter(|case| case["admitted"] == admitted)
        {
            ...
            let env = ExecutorEnv::builder()
                ...
                .build()
                .unwrap();
            eprintln!("actual EXISTS/BOUND guest case {}", case["id"]);
