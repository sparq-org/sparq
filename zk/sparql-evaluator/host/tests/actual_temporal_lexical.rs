...
#[test]
fn actual_guest_executes_temporal_lexical_and_constructor_boundaries() {
    ...
    let executor = ExternalProver::new("real-sparq-temporal-lexical", r0vm);
    ...
    for case in corpus["cases"].as_array().unwrap() {
        ...
        eprintln!("actual temporal lexical guest case {}", case["id"]);
