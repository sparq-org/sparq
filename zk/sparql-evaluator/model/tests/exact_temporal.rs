...
#[test]
fn v2_exact_temporal_goldens_are_admitted_and_evaluated_by_the_native_model() {
...
#[test]
fn v2_temporal_capacity_rejections_are_global_in_the_model() {
    use sparq_proved_evaluator_model::v2::{
        Dialect, Policy, PrivateDataset, Request, VERSION, Witness, dataset_commitment, evaluate,
    };
    let corpus: serde_json::Value = serde_json::from_str(include_str!(
        "../../fixtures/conformance/temporal-capacity.json"
    ))
