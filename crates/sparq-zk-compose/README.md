...
[GPT-6] How-to: [ZK query proofs](../../skills/zk-query-proofs/SKILL.md), [disclosure planning](../../skills/zk-query-proofs/references/disclosure-planner.md) (including separate canonical signed-integer host admission), and the opt-in [successful-result contract](../../skills/zk-query-proofs/references/successful-results.md).
