...
EXISTS/NOT EXISTS bodies admit BGP/join/UNION, pure FILTER and the
[scoped published-2013 MINUS rule](../../sparql-query/exists-minus.md), including
fixed sequences lowered to BGP. [Captured BOUND](exists-bound-scope.md)
is rejected; local-only BOUND remains admitted. Nested EXISTS, residual paths,
OPTIONAL, binding operators, subqueries and modifiers inside those bodies
